...
public class ExJList extends JFrame implements ListSelectionListener, ActionListener
    //LEMBRANDO QUE HERANÇA SO PODER HERDAR 1, E INTERFACE VARIAS
{
    // Criando objetos Label, Texto  e Botões
    JLabel l1;  JTextField t1;    JButton bquant,bindice,bclear,badd;
    ...
    // Tratando os eventos
    public void actionPerformed(ActionEvent e)// cria a opção de eventos para o botao
    {
